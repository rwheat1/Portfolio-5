...
So we've got a main effect of caffeine, a trend of sugar, and an interaction. Let's look at the descriptives, and plot our results so we can be more specific with this interpretation.
...
ggplot(backpack_data, aes(x = caffeine, y = Distance_Est, fill = sugar)) +
  ...
  labs(title = "The Effects of Caffeine and Sugar on Distance Perception", x = "Caffeine", y = "Estimated Distance (m)", fill = "Sugar") + 
  theme_bw() +
